...
export class Home extends React.Component<{}, {}> {
    ...
    render() {
        ...
        <Container>
                ...
                <br></br>
                <Header as='h2'>
                <Button fluid onClick={()=>this.handleButton("ansokningar")} color='olive' size='massive'>Sök behörigheter</Button>
                <Header.Subheader>Här kan du söka behörigheter, behörighetsgrupper eller miljögrupper</Header.Subheader>
                </Header>

                <Header as='h2'>
                <Button fluid onClick={()=>this.handleButton("minaansokningar")} color='olive' size='massive'>Mina behörigheter</Button>
